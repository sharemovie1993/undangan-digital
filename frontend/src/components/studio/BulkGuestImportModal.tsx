      ...
      <div className="w-full max-w-xl bg-[#111115] border border-[#c4a661]/40 rounded-3xl p-5 sm:p-7 space-y-4 shadow-2xl my-auto animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-serif text-base font-bold text-white flex items-center gap-2">
                <span>Impor Tamu Massal</span>
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 font-sans font-semibold">
                  Excel & CSV
                </span>
              </h3>
              <p className="text-[11px] text-neutral-400">
                Impor puluhan hingga ratusan nama tamu dalam hitungan detik.
              </p>
            </div>
          </div>
          <button
        ...
        {activeTab === 'excel' && (
          <div className="space-y-3.5 text-xs">
            ...
            <div className="flex items-center justify-between p-3 rounded-2xl bg-neutral-900/80 border border-neutral-800 gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 border border-emerald-500/40 text-xs font-bold flex items-center gap-1.5 transition cursor-pointer shrink-0"
              >
            ...
            <div className="relative border-2 border-dashed border-neutral-700 hover:border-[#c4a661] rounded-2xl p-6 text-center transition bg-neutral-950/60 group cursor-pointer">
              <input
                type="file"
                accept=".xlsx, .xls, .csv"
              ...
              <div className="flex flex-col items-center justify-center gap-2 pointer-events-none">
                <div className="w-12 h-12 rounded-2xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-[#c4a661] group-hover:scale-110 transition">
                  <Upload className="w-6 h-6" />
                </div>
                <div>
                  <p className="text-xs font-bold text-white">
                    {uploadedFileName ? uploadedFileName : 'Klik atau Tarik File Excel / CSV ke Sini'}
                  </p>
