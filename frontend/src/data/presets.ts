...
export const THEMES = {
  ...
  // --- KOLEKSI TEMA CERAH (LIGHT MODE & SACRED LUXURY) ---
  ivory_gold: {
    id: 'ivory_gold' as const,
    ...
    badge: 'bg-[#f4eee4] text-[#bfa15f] border-[#bfa15f]/30',
  ...
  soft_blush_floral: {
    ...
    badge: 'bg-[#faedf0] text-[#c4687d] border-[#c4687d]/30',
  ...
  botanical_sage: {
    ...
    badge: 'bg-[#e8f2ec] text-[#43785d] border-[#43785d]/30',
  ...
  terracotta_cream: {
    ...
    badge: 'bg-[#f5ebe3] text-[#b35d3d] border-[#b35d3d]/30',
  ...
  celestial_blue: {
    ...
    badge: 'bg-[#e4eff7] text-[#3d6e94] border-[#3d6e94]/30',
  ...
  javanese_heritage: {
    ...
    badge: 'bg-[#f3ead3] text-[#9c6828] border-[#9c6828]/30',
...
export const MASTER_STYLE_KITS = {
  ...
  soft_blush_garden: {
    ...
    themeId: 'soft_blush_floral' as const,
    fontPairingId: 'romantic_calligraphy' as const,
    frameShape: 'soft_oval' as const,
  ...
  botanical_sage_light: {
    ...
    themeId: 'botanical_sage' as const,
    fontPairingId: 'islamic_arabic' as const,
    frameShape: 'islamic_dome' as const,
  ...
  javanese_ningrat_gold: {
    ...
    themeId: 'javanese_heritage' as const,
    fontPairingId: 'royal_serif' as const,
    frameShape: 'royal_arch' as const,
